...
<head>
   ...
   <title>Buffet Land Website - Order Page</title>
...
<body>
   ...
   <section class="navbar">
      <div class="container">
         <div class="logo">
            <a href="#" title="Logo">
               <img src="images/Logo_Bf.png" alt="Restaurant Logo" class="img-responsive">
               </a>
         </div>
         ...
         <div class="menu text-right">
            <ul>
               ...
               <li>
               <a href="index.php?logout=<?php echo $user_id; ?>" onclick="return confirm('are your sure you want to logout?');">logout</a>
               </li>
             </ul>
         </div>
